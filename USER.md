...
`USER.md` is a structured markdown profile that describes a person to AI agents. Create it once at **[OpenUser.ai](https://openuser.ai)** — every agent that reads it understands you: your background, preferences, communication style, and how to work with you.
...
1. **Create** — Complete the onboarding interview at OpenUser.ai. Your USER.md is generated from your answers and published at `openuser.ai/yourname`.
2. **Install the plugin** — Add the OpenUser plugin to your agent (Claude, Cursor, ChatGPT etc.) and configure your username once during setup.
...
`USER.md` is plain markdown. Sections use `#` headers. Only `User Profile` is required — everything else is optional.
...
- **Profile:** openuser.ai/alexwren
- **Role:** Project Manager
- **Company:** Amko Corp
- **Skills:** Roadmapping, stakeholder management, agile delivery
- **Tools:** Notion, Linear, Slack, Claude, ChatGPT
- **Accepts:** Meetings, proposals, questions
- **Open to:** Consulting, advisory roles, speaking opportunities
...
Always show your reasoning. If unsure, say so.
...
|---|---|---|
| `User Profile` | **Yes** | Name, identity, location, professional background and reachability |
| `Communication` | No | How agents should respond to you |
| `Work Style` | No | Decision-making and collaboration preferences |
| `Constraints` | No | Hard rules agents must follow |
| `Agent Instructions` | No | Free-form directives for AI behavior |
| `Additional Context` | No | Freeform notes — projects, interests, anything relevant |
